...
import { loadKit, getActiveKit } from '../audio/drumKit'
...
export default function GeneratePage() {
  ...
  useEffect(() => () => stop(), [stop])
  // Preload the selected drum kit so audition plays real drums (decodes on a
      ...
      <div className="w-full max-w-4xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        {out && (
          <div className="border border-hairline bg-surface p-6 mb-8">
            ...
            {/* Kit selector */}
            <div className="mb-4"><KitPicker /></div>
        ...
        <p className="text-faint text-[11px] leading-relaxed pb-16 max-w-xl">
          You get a full multi-section track — intro, build, drop, breakdown and outro, with instruments coming and going, fills and risers. Chords, a sampled lead synth arpeggio, a sustained pad and a real sampled vocal topline all follow the progression. Drop the MIDI into FL Studio and finish it. It's a genre-accurate skeleton, not a mastered record — structures follow templates.
        </p>
      </div>
    </div>
  )
