      ...
      <div className="w-full max-w-6xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        <nav className="flex items-center justify-between py-5 border-b border-hairline">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            {/* ['Player', '/player'] and ['DJ Deck', '/dj'] removed while those
                pages are disabled in App.jsx — add them back here to restore. */}
            {[['Generate', '/generate'], ['Isolator', '/isolator'], ['Community', '/community'], ['Tips', '/tips'], ['Tools', '/tools']].map(([l, p]) => (
        ...
        <div className="flex flex-wrap gap-2 mb-10 sm:hidden">
          {/* ['Player', '/player'] and ['DJ Deck', '/dj'] removed while those
              pages are disabled in App.jsx — add them back here to restore. */}
          {[['Vocal Isolator', '/isolator'], ['Tips & Shortcuts', '/tips'], ['Production Tools', '/tools']].map(([l, p]) => (
